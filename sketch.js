...
function preload(){
  sonic_running = loadAnimation("sonic1.webp","sonic2.webp","sonic3.webp","sonic4.webp","sonic5.webp","sonic6.webp");
  //sonic_collided = loadAnimation("mariodead.png");
...
function draw() {
  ...
  if(coinGroup.isTouching(sonic)){
   ...
   if(obstaclesGroup.isTouching(sonic)){
    ...
    sonic.changeAnimation("collided",mario_collided);
    sonic.scale =0.35;
